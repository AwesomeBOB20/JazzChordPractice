...
export const CH: Record<string, {l:string,s:string,iv:number[],r:string[],f:string[]}> = {
  ...
  'min7':     {l:'Min 7',      s:'m7',     iv:[0,3,7,10],     r:['root','b3rd','5th','7th'],                  f:['R','b3','5','b7']},
  ...
  'min9':     {l:'Min 9',      s:'m9',     iv:[0,3,7,10,14],  r:['root','b3rd','5th','7th','9th'],            f:['R','b3','5','b7','9']},
  ...
  'min13':    {l:'Min 13',     s:'m13',    iv:[0,3,7,10,14,21], r:['root','b3rd','5th','7th','9th','13th'],     f:['R','b3','5','b7','9','13']},
  ...
  'dom7sus4': {l:'7 Sus4',     s:'7sus4',  iv:[0,5,7,10],     r:['root','4th','5th','7th'],                  f:['R','4','5','b7']},
  'dom7alt':  {l:'7alt',       s:'7alt',   iv:[0,4,8,10,13,15], r:['root','3rd','#5th','7th','b9th','#9th'],  f:['R','3','#5','b7','b9','#9']},
  ...
  'dom7b13':  {l:'7♭13',       s:'7♭13',   iv:[0,4,7,10,14,20], r:['root','3rd','5th','7th','9th','b13th'],    f:['R','3','5','b7','9','b13']},
  'dom7b9':   {l:'7♭9',        s:'7♭9',    iv:[0,4,7,10,13],  r:['root','3rd','5th','7th','b9th'],           f:['R','3','5','b7','b9']},
  ...
  'min11':    {l:'Min 11',     s:'m11',    iv:[0,3,7,10,14,17], r:['root','b3rd','5th','7th','9th','11th'],     f:['R','b3','5','b7','9','11']},
  ...
  'dom13b9':  {l:'13♭9',       s:'13♭9',   iv:[0,4,7,10,13,17,21], r:['root','3rd','5th','7th','b9th','11th','13th'], f:['R','3','5','b7','b9','11','13']},
  'dom13s9':  {l:'13♯9',       s:'13♯9',   iv:[0,4,7,10,15,17,21], r:['root','3rd','5th','7th','#9th','11th','13th'], f:['R','3','5','b7','#9','11','13']},
  'dom7b5b9': {l:'7♭5♭9',      s:'7♭5♭9',  iv:[0,4,6,10,13],    r:['root','3rd','b5th','7th','b9th'],          f:['R','3','b5','b7','b9']},
  'dom7b5s9': {l:'7♭5♯9',      s:'7♭5♯9',  iv:[0,4,6,10,15],    r:['root','3rd','b5th','7th','#9th'],          f:['R','3','b5','b7','#9']},
  'dom7s5b9': {l:'7♯5♭9',      s:'7♯5♭9',  iv:[0,4,8,10,13],    r:['root','3rd','#5th','7th','b9th'],          f:['R','3','#5','b7','b9']},
  'dom7s5s9': {l:'7♯5♯9',      s:'7♯5♯9',  iv:[0,4,8,10,15],    r:['root','3rd','#5th','7th','#9th'],          f:['R','3','#5','b7','#9']},
  'dom7b5':   {l:'7♭5',        s:'7♭5',    iv:[0,4,6,10],       r:['root','3rd','b5th','7th'],                 f:['R','3','b5','b7']},
...
export const SCALES: Record<string, { name: string; iv: number[]; r: string[]; f: string[] }> = {
  ...
  'dorian':       { name: 'Dorian',                     iv: [0,2,3,5,7,9,10],    r: ['root','2nd','b3rd','4th','5th','6th','7th'],     f: ['R','2','b3','4','5','6','b7'] },
  'phrygian':     { name: 'Phrygian',                   iv: [0,1,3,5,7,8,10],    r: ['root','2nd','b3rd','4th','5th','6th','7th'],     f: ['R','b2','b3','4','5','b6','b7'] },
  ...
  'aeolian':      { name: 'Aeolian (Natural Minor)',    iv: [0,2,3,5,7,8,10],    r: ['root','2nd','b3rd','4th','5th','6th','7th'],     f: ['R','2','b3','4','5','b6','b7'] },
  'locrian':      { name: 'Locrian',              iv: [0,1,3,5,6,8,10],    r: ['root','2nd','b3rd','4th','5th','6th','7th'],     f: ['R','b2','b3','4','b5','b6','b7'] },
  'maj_pent':     { name: 'Major Pentatonic',     iv: [0,2,4,7,9],         r: ['root','2nd','3rd','5th','6th'],                 f: ['R','2','3','5','6'] },
  'min_pent':     { name: 'Minor Pentatonic',     iv: [0,3,5,7,10],        r: ['root','b3rd','4th','5th','7th'],                 f: ['R','b3','4','5','b7'] },
  'blues':        { name: 'Blues',                iv: [0,3,5,6,7,10],      r: ['root','b3rd','4th','b5th','5th','7th'],          f: ['R','b3','4','b5','5','b7'] },
  ...
  'dim_hw':       { name: 'HW Diminished',        iv: [0,1,3,4,6,7,9,10],  r: ['root','b2nd','b3rd','3rd','b5th','5th','6th','7th'],f: ['R','b2','b3','3','b5','5','6','b7'] },
  ...
  'locrian_nat2': { name: 'Locrian ♮2',           iv: [0,2,3,5,6,8,10],    r: ['root','2nd','b3rd','4th','5th','6th','7th'],     f: ['R','2','b3','4','b5','b6','b7'] },
  ...
  'aeolian_dom':  { name: 'Aeolian Dominant',     iv: [0,2,4,5,7,8,10],    r: ['root','2nd','3rd','4th','5th','6th','7th'],     f: ['R','2','3','4','5','b6','b7'] },
  'bebop_min':    { name: 'Bebop Minor',          iv: [0,2,3,4,5,7,9,10],  r: ['root','2nd','b3rd','3rd','4th','5th','6th','7th'],f: ['R','2','b3','3','4','5','6','b7'] },
  ...
  'hung_min':     { name: 'Hungarian Minor',      iv: [0,2,3,6,7,8,11],    r: ['root','2nd','b3rd','4th','5th','6th','7th'],     f: ['R','2','b3','#4','5','b6','7'] },
  'hung_maj':     { name: 'Hungarian Major',      iv: [0,3,4,6,7,9,10],    r: ['root','2nd','3rd','4th','5th','6th','7th'],     f: ['R','#2','3','#4','5','6','b7'] },
  'neapolitan_maj':{name: 'Neapolitan Major',     iv: [0,1,3,5,7,9,11],    r: ['root','2nd','b3rd','4th','5th','6th','7th'],     f: ['R','b2','b3','4','5','6','7'] },
  'neapolitan_min':{name: 'Neapolitan Minor',     iv: [0,1,3,5,7,8,11],    r: ['root','2nd','b3rd','4th','5th','6th','7th'],     f: ['R','b2','b3','4','5','b6','7'] },
  'hijaz':        { name: 'Hijaz',                iv: [0,1,4,5,7,9,10],    r: ['root','2nd','b3rd','4th','5th','6th','7th'],     f: ['R','b2','3','4','5','6','b7'] },
  'byzantine':    { name: 'Double Harmonic (Byzantine)', iv: [0,1,4,5,7,8,11], r: ['root','2nd','b3rd','4th','5th','6th','7th'], f: ['R','b2','3','4','5','b6','7'] },
};
